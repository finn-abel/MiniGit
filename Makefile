...
SRC = src/main.c src/commands.c src/fs.c src/hash.c src/object.c src/repository.c

# Add test source files here.
TEST_SRC = tests/test_commands.c tests/test_fs.c tests/test_hash.c tests/test_object.c
